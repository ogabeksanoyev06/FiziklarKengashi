<template>
  <div class="navigation-drawer">
    <BlockWrap
      ...
      <div class="header__search mb-30"
           v-if="!isDesktop"
      >
        <BaseInput hide-details
                   v-model="search"
    ...
    <div class="">
      ...
      <AppText class="mb-20 mobile-menu__title"
               size="20"
               line-height="26"
               weight="700"
      >Menu
      ...
      <ul class="mobile-menu-wrap" v-on-click-outside:excludedClass="hideMenus">
        ...
        >
          <span class="mobile-menu__link" @click="clickMenu()"> {{ item.title }}</span>
          <ul class="mobile-submenu" v-if="item.id === activeId">
            ...
            >
              ...
              <ul class="mobile-submenu__inner" v-if="submenu.id === subActiveId">
                <li class="mobile-submenu__item" v-for="(children, idx) in submenu.children" :key="idx">
...
export default {
  ...
  components: {BlockWrap, AppButton, BaseInput},
  data() {
    return {
      activeId: null,
      subActiveId: null,
